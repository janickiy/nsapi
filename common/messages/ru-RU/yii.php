...
return [
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.'=>'Показано <b>{begin, number}-{end, number}</b> из <b>{totalCount, number}</b> {totalCount, plural, one{элемент} other{элементов}}.',
    ...
    '{attribute} is not a valid email address.' => 'Не похоже на email.',
    ...
    'only {delta, plural, =1{a year} other{# years}}' => '{delta, plural, =1{# год} one{# год} few{# года} many{# лет} other{# года}} ',
    'only {delta, plural, =1{a month} other{# months}}' => '{delta, plural, =1{месяц} one{# месяц} few{# месяца} many{# месяцев} other{# месяца}} ',
    'only {delta, plural, =1{a day} other{# days}}' => '{delta, plural, =1{день} one{# день} few{# дня} many{и # дней} other{# дня}} ',
    'The above error occurred while the Web server was processing your request.'=>'В процессе обработки запроса произошла ошибка',
    'Please contact us if you think this is a server error. Thank you.'=>'Если ошибки повторяются свяжитесь с нами. Спасибо'
];
