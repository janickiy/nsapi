...
class TestPressureForm extends Model
{
    public $id;
    public $standard_id;
    public $hardness_id;
    ...
    public function rules(): array
    {
        return [
            ...
            [
                ...
                'targetClass' => TestPressure::class,
    ...
    public function attributeLabels(): array
    {
        return [
            ...
            'value' => 'Минимальное испытательно давление',
        ];
    }
     ...
     * @return void
     */
    public function loadData(TestPressure $model): void
    {
