...
use backend\services\references\StandardService;
...
class StandardController extends Controller
{
    ...
    {
        $model = new Standard();
        $modelForm = new StandardForm();
        if ($modelForm->load(Yii::$app->request->post()) && $modelForm->validate()) {
            try {
                $service = new StandardService($model);
     ...
     * @throws NotFoundHttpException
     */
    private function findModel($id): Standard
    {
        $model = Standard::findOne(intval($id));
        if (!$model) {
