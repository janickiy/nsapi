...
use backend\models\references\OuterDiameterSearch;
 ...
 * @var OuterDiameterSearch $searchModel
 */

$this->title = 'Наружний диаметр ГНКТ';
...
$columns = [
    ...
    [
        ...
        'value' => function (OuterDiameter $model) {
            return Yii::$app->formatter->asDecimal($model->millimeter, 2);
        }
    ],
    [
...
$dynaGridOptions = [
    ...
    'options' => ['id' => 'dynagrid-outer-diameter'],
];
