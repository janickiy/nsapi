...
use backend\models\references\HardnessLimitSearch;
 ...
 * @var HardnessLimitSearch $searchModel
 */

$this->title = 'Предел твердости';
...
$columns = [
    ...
    [
        ...
        'value' => function (HardnessLimit $model) {
...
$dynaGridOptions = [
    ...
    'options' => ['id' => 'dynagrid-hardness-limit'],
];
