...
use backend\services\references\HardnessLimitService;
...
class HardnessLimitController extends Controller
{
    use BaseExceptionProcessingErrorsTrait;

    const GRID_NAME = 'grid_hardness_limit';
    ...
    {
        $searchModel = new HardnessLimitSearch();
    ...
    {
        $model = new HardnessLimit();
        $modelForm = new HardnessLimitForm();
        if ($modelForm->load(Yii::$app->request->post()) && $modelForm->validate()) {
            try {
                $service = new HardnessLimitService($model);
     ...
     * @throws NotFoundHttpException
     */
    private function findModel($id): HardnessLimit
    {
        $model = HardnessLimit::findOne(intval($id));
        if (!$model) {
