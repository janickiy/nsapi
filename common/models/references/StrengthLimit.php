 ...
 */
class StrengthLimit extends ActiveRecord
{
    /**
     * @return string
     */
    ...
    {
        return 'references.strength_limit';
    }
     ...
     * @return StrengthLimit|null
     */
    public static function findByCertificate(Certificate $certificate): ?StrengthLimit
    {
        /** @var StrengthLimit $model */
        $model = self::find()
            ->where([
